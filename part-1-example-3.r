...
author = c('John Smith', 'Dans Game', 'Wut Face', 'Kappa Ross', 'Alma Mater', 'Fak Yu')
...
data = data.frame(authors, books, year, sold, rating)

# Group by author, then calculate each author's average rating and book sold counts
data_set_1 = data %>%
              group_by(author) %>%
